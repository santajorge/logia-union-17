  ...
  return (
    <div style={{ maxWidth: '1000px', fontFamily: 'var(--font-montserrat)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <Link 
          href="/panel/tesoreria/ingresos/nuevo" 
      ...
      <div style={estiloSeccion}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', paddingBottom: '10px', borderBottom: '1px solid rgba(207, 181, 59, 0.15)' }}>
          ...
          <p style={{ fontSize: '15px', fontWeight: '700', color: '#4A8516', margin: 0 }}>
        ...
        {cargando ? (
          ...
          <p style={{ fontSize: '14px', color: 'var(--color-gris)', padding: '1.5rem 0', margin: 0, textAlign: 'center' }}>No hay ingresos registrados aún.</p>
        ) : (
              ...
              <tbody>
                {ingresos.map((ingreso, i) => (
                  ...
                  >
                    ...
                    <td style={{ ...estiloTd, color: 'var(--color-institucional)', fontWeight: '500' }}>{ingreso.descripcion}</td>
